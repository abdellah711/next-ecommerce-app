...
const ProductCard = ({ title, image, price, oldPrice, link }: Props) => {
    ...
    return (
        <Link href={link} className="p-3 flex flex-col gap-2 relative bg-zinc-50 rounded-md embla__slide flex-shrink-0 sm:basis-1/2 md:basis-1/3 lg:basis-1/4 hover:scale-105 transition">
